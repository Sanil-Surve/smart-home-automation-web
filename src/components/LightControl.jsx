...
//           <Lottie loop animationData={lightData} play className="w-full h-full rounded-md" />
//         </div>
//       </Flex>
...
const LightControl = ({ toggleDevice }) => {
  ...
  return (
    <Card className="text-center p-4 shadow-xl rounded-xl bg-gray-800 text-white flex flex-col gap-4">
      <h2 className="text-2xl font-semibold">Bedroom</h2>
      <Flex justify="center">
        <div className="w-64 h-64 flex items-center justify-center">
          <Lottie
      ...
      <h3 className="text-lg">
        Light Bulb:{" "}
        <span className={lightStatus === "ON" ? "text-green-500" : "text-red-500"}>
          {lightStatus}
        </span>
      </h3>
      <Switch
