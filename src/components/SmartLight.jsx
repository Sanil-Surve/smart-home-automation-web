...
// const MQTT_BROKER = import.meta.env.VITE_MQTT_BROKER;
// const MQTT_TOPIC_LIGHT = import.meta.env.VITE_MQTT_TOPIC;
// const MQTT_TOPIC_TEMP = "home/temperature";
// const MQTT_TOPIC_HUMID = "home/humidity";
// const MQTT_USER = import.meta.env.VITE_MQTT_USER;
// const MQTT_PASS = import.meta.env.VITE_MQTT_PASS;
...
//       console.log("✅ Connected to MQTT Broker");
//       setIsConnected(true);
//       mqttClient.subscribe([MQTT_TOPIC_LIGHT, MQTT_TOPIC_TEMP, MQTT_TOPIC_HUMID]);
//     });
...
//       if (topic === MQTT_TOPIC_LIGHT) setStatus(payload);
//       if (topic === MQTT_TOPIC_TEMP) setTemperature(payload);
//       if (topic === MQTT_TOPIC_HUMID) setHumidity(payload);
//     });
...
//     return () => {
//       if (clientRef.current) {
//         clientRef.current.unsubscribe([MQTT_TOPIC_LIGHT, MQTT_TOPIC_TEMP, MQTT_TOPIC_HUMID]);
//         clientRef.current.end(true);
//       }
//     };
//   }, []);
...
//     const newStatus = checked ? "ON" : "OFF";
//     if (newStatus !== status) {
//       clientRef.current.publish(MQTT_TOPIC_LIGHT, newStatus);
//       setStatus(newStatus);
//     }
//   };
...
//   return (
//     <Card className="text-center mt-12 p-6 shadow-lg rounded-xl bg-gray-800">
//       <h1 className="md:text-2xl font-semibold mb-10 text-gray-200">Zenith Smart</h1>

//       <Flex justify="center" align="center">{LightAnimation}</Flex>

//       <h3 className="mt-10 text-lg text-gray-300">
//         Room Light <strong className="text-blue-600">{status}</strong>
//       </h3>
...
//         <h3>🌡 Temperature: <strong className="text-yellow-500">{temperature ? `${temperature}°C` : "--"}</strong></h3>
//         <h3>💧 Humidity: <strong className="text-blue-400">{humidity ? `${humidity}%` : "--"}</strong></h3>
//       </div>
//     </Card>
//   );
// };
